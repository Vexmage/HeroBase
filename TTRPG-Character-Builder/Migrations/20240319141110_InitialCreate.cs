    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartyCharacter", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PartyCharacter_characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "characters",
                        principalColumn: "CharacterId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PartyCharacter_parties_PartyId",
                        column: x => x.PartyId,
                        principalTable: "parties",
                        principalColumn: "PartyId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartyCharacter_CharacterId",
                table: "PartyCharacter",
                column: "CharacterId");

            migrationBuilder.CreateIndex(
                name: "IX_PartyCharacter_PartyId",
                table: "PartyCharacter",
                column: "PartyId");
        }
